		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comrhldemoappforme-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrhldemoappforme-display": {
								"semanticObject": "comrhldemoappforme",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rhl.demoappforme",
									"url": sap.ui.require.toUrl("com/rhl/demoappforme")
								}
							}
						}
					}
